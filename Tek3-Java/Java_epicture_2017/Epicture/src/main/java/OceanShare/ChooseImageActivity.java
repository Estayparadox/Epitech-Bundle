...
import OceanShare.login.LoginActivity;
import OceanShare.login.RefreshAccessTokenTask;
...
public class ChooseImageActivity extends ActionBarActivity {
    ...
    // when pickImage is selected
    public void pickImage(View view) {
		Intent i = new Intent(Intent.ACTION_PICK, android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
		startActivityForResult(i, REQ_CODE_PICK_IMAGE);
	}

    // when showImage is selected
    public void showImage(View view) {
        Intent intent = new Intent(this, ImgurShowTask.class);
